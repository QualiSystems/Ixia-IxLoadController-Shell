...
**To configure a service for the device:**
  ...
  2. In the **Traffic Generator Controller** folder, select **IxLoad Controller**.
   ...
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;![](https://github.com/QualiSystems/Ixia-IxLoadController-Shell/blob/master/ixload_controller.png)
...
5. Edit the **IxLoad Controller** service parameters if required, see [Configuring a new service](#configuring_a_new_service).
